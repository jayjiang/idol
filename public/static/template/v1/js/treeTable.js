layui.define(['jquery'], function(exports) {
	...
	// 全选
	tree.prototype.checkAll = function(e) {
		var t = this;
		o(e.elem).find('.cbx').each(function() {
			o(this).addClass("layui-form-checked")
		})
	};

	// 全不选
	tree.prototype.uncheckAll = function(e) {
		var t = this;
		o(e.elem).find('.cbx').each(function() {
			o(this).removeClass("layui-form-checked")
		})
	};

	// 反选 reverseCheck
	tree.prototype.reverseCheck = function(e) {
		o(e.elem).find('.cbx').each(function() {
			if (o(this).hasClass("layui-form-checked")){
				o(this).removeClass('layui-form-checked');
			}else{
				o(this).addClass('layui-form-checked')
			}
